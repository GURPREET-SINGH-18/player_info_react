...
export default function UpdatePlayer() {
  ...
  let postData = async()=>{
      ...
      let res=await fetch(`http://127.0.0.1:8000/player/${id}/`,options);
      console.log(res)
      if(res.status===200) {
  ...
  <div className="mt-4 mb-4">
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
          ...
          <Form.Control as="textarea" placeholder="Enter Player Information" name="small_info" value={pdata.small_info} onChange={formhandle} />
      </Form.Group>
      <Form.Group controlId="formFileSm" className="mb-3">
          <Form.Label><strong>Enter Player Photo</strong></Form.Label>
          <Form.Control type="file"
              name="photo"
              accept="photo/png, photo/jpeg" defaultValue={pdata.photo}  onChange={imghandle}  />
              <img src={pdata.photo} alt="" style={{height: '70px',width: '80px',marginTop: '9px'}}/>
      </Form.Group>
